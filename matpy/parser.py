...
from matpy.ast_nodes import (
    ...
    GlobalStmt, PersistentStmt, ClassDef, Expr, Stmt,
)
...
class Parser:
    ...
    def _parse_try(self) -> TryCatchStmt:
        ...
        self._expect(TokenType.END)
        self._consume_stmt_end()
        return TryCatchStmt(try_body=try_body, catch_var=catch_var, catch_body=catch_body)
    ...
    def _parse_block_until_branch(self) -> list[Stmt]:
        stop = {TokenType.END, TokenType.ELSEIF, TokenType.ELSE,
                TokenType.OTHERWISE, TokenType.CATCH, TokenType.CASE}
        stmts: list[Stmt] = []
        self._skip_newlines()
    ...
    def _parse_comparison(self) -> Expr:
        ...
        for tt in (TokenType.EQ, TokenType.NEQ, TokenType.LT,
    ...
    def _parse_mul_expr(self) -> Expr:
        ...
        while self._peek().type in (
            TokenType.STAR, TokenType.SLASH, TokenType.BACKSLASH,
            TokenType.DOT_STAR, TokenType.DOT_SLASH, TokenType.DOT_BACKSLASH,
            TokenType.CARET, TokenType.DOT_CARET,
        ):
            op_tok = self._advance()
