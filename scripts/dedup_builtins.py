...
files_remove_register_only = {
    'advanced_math.py': ['anova1', 'chi2gof', 'fminbnd', 'fmincon', 'fminsearch', 'fzero',
                         'integral', 'integral2', 'interp1', 'interp2', 'interp3', 'kron',
                         'linprog', 'mkpp', 'mode', 'ode15s', 'ode23', 'ode45', 'ppval',
                         'prctile', 'quantile', 'spline', 'ttest', 'ttest2'],
    'matrix_ops.py': ['blkdiag', 'conv', 'cross', 'deconv', 'det', 'dot', 'fft', 'fftshift',
                       'find', 'hankel', 'hess', 'ifft', 'ifftshift', 'intersect', 'inv',
                       'ischar', 'isempty', 'isequal', 'ismember', 'islogical', 'isnumeric',
                       'kron', 'meshgrid', 'ndgrid', 'norm', 'pinv', 'rank', 'schur',
                       'setdiff', 'setxor', 'sort', 'toeplitz', 'union', 'unique'],
    'data_struct.py': ['cell2mat', 'iscell', 'isstruct', 'mat2cell', 'num2cell', 'numel'],
}

# Intra-module: remove second+ @register occurrence
intra_to_remove = {
    'data_struct.py': ['array2table', 'cellfun', 'containers_Map', 'isKey', 'keys', 'table', 'table2array', 'values'],
    'statistics.py': ['bootstrp', 'geomean', 'harmmean', 'iqr', 'jackknife', 'kurtosis', 'skewness', 'tabulate', 'zscore'],
    'matrix_ops.py': ['cat', 'diag', 'fliplr', 'flipud', 'horzcat', 'length', 'linspace', 'logspace', 'ndims', 'repmat', 'reshape', 'size', 'tril', 'triu', 'vertcat'],
    'advanced_math.py': ['cond', 'expm', 'logm', 'sqrtm'],
    'plotting.py': ['contour', 'contourf', 'gcf', 'mesh', 'plot3', 'saveas', 'subplot', 'surf'],
    'image.py': ['edge', 'histeq', 'imadjust', 'imbinarize', 'imclose', 'imcrop', 'imdilate', 'imerode', 'imfilter', 'imhist', 'imopen', 'imresize', 'imrotate'],
    'control.py': ['dcgain', 'feedback', 'isstable', 'minreal', 'parallel', 'pole', 'series', 'zero', 'zpk'],
